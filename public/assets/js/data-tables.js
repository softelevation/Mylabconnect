...
var dataSet = [
  ...
  var dataSet1 = [
    ...
    var dataSet2 = [
      ...
      var dataSet3 = [
          [ "APT0001", "<img src='https://via.placeholder.com/216x62' style='width:50px; height:30px;'>Denise", "39", "Henry Daniels", "Cardiology", "11 Dec 2019", "10:00am-12:00am", "Cold",  "<a href='#'><i class='fas fa-pencil-alt ms-text-primary'></i></a>   <a href='#'><i class='far fa-trash-alt ms-text-danger'></i></a>" ],
          [ "APT0002", "<img src='https://via.placeholder.com/216x62' style='width:50px; height:30px;'>Jennifer", "29", "Doris Wilder", "Gynaecology", "5 Dec 2019", "10:00am-12:00am",  "Fever",  "<a href='#'><i class='fas fa-pencil-alt ms-text-primary'></i></a>   <a href='#'><i class='far fa-trash-alt ms-text-danger'></i></a>" ],
          ...
          [ "APT0004", "<img src='https://via.placeholder.com/216x62' style='width:50px; height:30px;'>Judy", "23", "Yuri Berry", "Orthopedics", "19 Dec 2019", "10:00am-12:00am", "Diabeties", "<a href='#'><i class='fas fa-pencil-alt ms-text-primary'></i></a>   <a href='#'><i class='far fa-trash-alt ms-text-danger'></i></a>" ],
          [ "APT0005", "<img src='https://via.placeholder.com/216x62' style='width:50px; height:30px;'>Kyle", "55", "Henry Daniels", "Radiotherapy","15 Dec 2019", "10:00am-12:00am", "Cold",  "<a href='#'><i class='fas fa-pencil-alt ms-text-primary'></i></a>   <a href='#'><i class='far fa-trash-alt ms-text-danger'></i></a>" ],
          [ "APT0006", "<img src='https://via.placeholder.com/216x62' style='width:50px; height:30px;'>Denise", "39", "Henry Daniels", "Cardiology","11 Dec 2019", "10:00am-12:00am", "heart",   "<a href='#'><i class='fas fa-pencil-alt ms-text-primary'></i></a>   <a href='#'><i class='far fa-trash-alt ms-text-danger'></i></a>" ],
          [ "APT0007", "<img src='https://via.placeholder.com/216x62' style='width:50px; height:30px;'>Jennifer", "29", "Doris Wilder", "Gynaecology", "5 Dec 2019", "10:00am-12:00am","Diabeties", "<a href='#'><i class='fas fa-pencil-alt ms-text-primary'></i></a>   <a href='#'><i class='far fa-trash-alt ms-text-danger'></i></a>" ],
          ...
          [ "APT0009", "<img src='https://via.placeholder.com/216x62' style='width:50px; height:30px;'>Judy", "23", "Yuri Berry", "Orthopedics", "19 Dec 2019", "10:00am-12:00am", "Asthma",  "<a href='#'><i class='fas fa-pencil-alt ms-text-primary'></i></a>   <a href='#'><i class='far fa-trash-alt ms-text-danger'></i></a>" ],
          [ "APT000a0", "<img src='https://via.placeholder.com/216x62' style='width:50px; height:30px;'>Kyle", "55", "Henry Daniels", "Radiotherapy", "15 Dec 2019", "10:00am-12:00am", "heart",  "<a href='#'><i class='fas fa-pencil-alt ms-text-primary'></i></a>   <a href='#'><i class='far fa-trash-alt ms-text-danger'></i></a>" ],
          [ "APT000a1", "<img src='https://via.placeholder.com/216x62' style='width:50px; height:30px;'>Denise", "39", "Henry Daniels", "Cardiology", "11 Dec 2019", "10:00am-12:00am",  "Cold",    "<a href='#'><i class='fas fa-pencil-alt ms-text-primary'></i></a>   <a href='#'><i class='far fa-trash-alt ms-text-danger'></i></a>" ],
          [ "APT000a2", "<img src='https://via.placeholder.com/216x62' style='width:50px; height:30px;'>Jennifer", "29", "Doris Wilder", "Gynaecology", "5 Dec 2019", "10:00am-12:00am", "Asthma",   "<a href='#'><i class='fas fa-pencil-alt ms-text-primary'></i></a>   <a href='#'><i class='far fa-trash-alt ms-text-danger'></i></a>" ],
          [ "APT000a3", "<img src='https://via.placeholder.com/216x62' style='width:50px; height:30px;'>Denise", "39", "Henry Daniels", "Cardiology", "11 Dec 2019", "10:00am-12:00am",  "Fever",   "<a href='#'><i class='fas fa-pencil-alt ms-text-primary'></i></a>   <a href='#'><i class='far fa-trash-alt ms-text-danger'></i></a>" ],
          [ "APT000a4", "<img src='https://via.placeholder.com/216x62' style='width:50px; height:30px;'>Jennifer", "29", "Doris Wilder", "Gynaecology", "5 Dec 2019", "10:00am-12:00am",  "Diabeties",  "<a href='#'><i class='fas fa-pencil-alt ms-text-primary'></i></a>   <a href='#'><i class='far fa-trash-alt ms-text-danger'></i></a>" ],
          [ "APT000a5", "<img src='https://via.placeholder.com/216x62' style='width:50px; height:30px;'>Denise", "39", "Henry Daniels", "Cardiology", "11 Dec 2019", "10:00am-12:00am", "heart",     "<a href='#'><i class='fas fa-pencil-alt ms-text-primary'></i></a>   <a href='#'><i class='far fa-trash-alt ms-text-danger'></i></a>" ],
          [ "APT000a6", "<img src='https://via.placeholder.com/216x62' style='width:50px; height:30px;'>Jennifer", "29", "Doris Wilder", "Gynaecology", "5 Dec 2019", "10:00am-12:00am",  "Cold",  "<a href='#'><i class='fas fa-pencil-alt ms-text-primary'></i></a>   <a href='#'><i class='far fa-trash-alt ms-text-danger'></i></a>" ],
              ...
              [ "14", "jennifer" ,"AC-2nd Floor","Lorem Ipsum is simply dummy text of the printing.","1/2",   "<a href='#'><i class='fas fa-pencil-alt ms-text-primary'></i></a> <a href='#'><i class='far fa-trash-alt ms-text-danger'></i></a>" ],
                    ...
                    var dataSet6 = [
                      ...
                      var dataSet7 = [
                          ...
                          [ "7", "<img src='https://via.placeholder.com/216x62' style='width:50px; height:30px;'>", "Jennifer", "jennifer@gmail.com", "San Francisco", "	(836) 257 1373",  "16 Nov 2019", "<a href='#'><i class='fas fa-pencil-alt ms-text-primary'></i></a>   <a href='#'><i class='far fa-trash-alt ms-text-danger'></i></a>" ],
