(function($) {
 ...
 /* Engaged Users */
  ...
  gradientStrokeengagedUsers.addColorStop(0, '#00000000');

  var gradientFillengagedUsers = engagedUsersCtx.createLinearGradient(0, 0, 0, 450);
  gradientFillengagedUsers.addColorStop(0, "rgb(140 150 154 / 39%)");
  gradientFillengagedUsers.addColorStop(1, "rgb(140 150 154 / 89%)");
  ...
  gradientStrokepageImpressions.addColorStop(0, '#00000000');

  var gradientFillpageImpressions = pageImpressionsCtx.createLinearGradient(0, 0, 0, 450);
  gradientFillpageImpressions.addColorStop(0, "rgb(140 150 154 / 39%)");
  gradientFillpageImpressions.addColorStop(1, "rgb(140 150 154 / 89%)");
  ...
  // Overview slider
    ...
    gradientStroke.addColorStop(0, '#00000000');

    var gradientFill = ctx.createLinearGradient(0, 0, 0, 450);
    gradientFill.addColorStop(0, "rgb(140 150 154 / 39%)");
    gradientFill.addColorStop(1, "rgb(140 150 154 / 89%)");
    ...
    var lineChart = new Chart(ctx, {
      ...
      options: {
        ...
        gradientStroke2.addColorStop(0, '#00000000');

        var gradientFill2 = ctx2.createLinearGradient(0, 0, 0, 450);
        gradientFill2.addColorStop(0, "rgb(140 150 154 / 39%)");
        gradientFill2.addColorStop(1, "rgb(140 150 154 / 89%)");
      ...
      gradientStrokeZCash.addColorStop(0, '#00000000');

      var gradientFillZCash = zCashCtx.createLinearGradient(0, 0, 0, 450);
      gradientFillZCash.addColorStop(0, "rgb(140 150 154 / 39%)");
      gradientFillZCash.addColorStop(1, "rgb(140 150 154 / 89%)");
    ...
    gradientStrokePeercoin.addColorStop(0, '#00000000');

    var gradientFillPeercoin = peerCoinCtx.createLinearGradient(0, 0, 0, 450);
    gradientFillPeercoin.addColorStop(0, "rgb(140 150 154 / 39%)");
    gradientFillPeercoin.addColorStop(1, "rgb(140 150 154 / 89%)");
