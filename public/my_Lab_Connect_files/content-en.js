...
function LoadglLangauge(message) {// Custom messages 
    ...
    switch (message) {
        ...
        case 4038:
            ...
            break;
        case 4039:
            lngMessage = "Columns in data file does not match selected fields.";
            break;
        case 4040:
...
lcm[39] = "Enter comments for cancellation";
...
lcm[450] = "Password should be alphanumeric characters with atleast one special character."
lcm[451] = "Contains";
lcm[452] = "Starts with";
